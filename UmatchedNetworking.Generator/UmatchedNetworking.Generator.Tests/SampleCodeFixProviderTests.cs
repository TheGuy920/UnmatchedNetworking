...
using Xunit;
using Verifier =
    Microsoft.CodeAnalysis.CSharp.Testing.XUnit.CodeFixVerifier<UnmatchedNetworking.Generator.SampleSyntaxAnalyzer,
        UnmatchedNetworking.Generator.SampleCodeFixProvider>;

namespace UnmatchedNetworking.Generator.Tests;
